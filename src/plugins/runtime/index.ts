...
import { whatsappMessageActions } from "../../channels/plugins/actions/whatsapp.js";
...
const updateProfilePictureWhatsAppLazy: PluginRuntime["channel"]["whatsapp"]["updateProfilePictureWhatsApp"] =
  async (...args) => {
    const { updateProfilePictureWhatsApp } = await loadWebOutbound();
    return updateProfilePictureWhatsApp(...args);
  };

const removeProfilePictureWhatsAppLazy: PluginRuntime["channel"]["whatsapp"]["removeProfilePictureWhatsApp"] =
  async (...args) => {
    const { removeProfilePictureWhatsApp } = await loadWebOutbound();
    return removeProfilePictureWhatsApp(...args);
  };

const updateGroupPictureWhatsAppLazy: PluginRuntime["channel"]["whatsapp"]["updateGroupPictureWhatsApp"] =
  async (...args) => {
    const { updateGroupPictureWhatsApp } = await loadWebOutbound();
    return updateGroupPictureWhatsApp(...args);
  };
const pinMessageWhatsAppLazy: PluginRuntime["channel"]["whatsapp"]["pinMessageWhatsApp"] = async (
  ...args
) => {
  const { pinMessageWhatsApp } = await loadWebOutbound();
  return pinMessageWhatsApp(...args);
};
...
function createRuntimeChannel(): PluginRuntime["channel"] {
  return {
    ...
    whatsapp: {
      ...
      updateProfilePictureWhatsApp: updateProfilePictureWhatsAppLazy,
      updateGroupPictureWhatsApp: updateGroupPictureWhatsAppLazy,
      removeProfilePictureWhatsApp: removeProfilePictureWhatsAppLazy,
      pinMessageWhatsApp: pinMessageWhatsAppLazy,
